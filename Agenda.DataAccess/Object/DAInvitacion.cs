...
namespace Agenda.DataAccess.Object
{
    public class DAInvitacion : DABase
    {
        ...
        public ENTResponse InsertInvitacion(ENTInvitacion oENTInvitacion, String sConnection, Int32 iAlternateDBTimeout){
            ...
            sqlPar.Value = oENTInvitacion.HoraEventoInicio;
            sqlCom.Parameters.Add(sqlPar);

            sqlPar = new SqlParameter("HoraEventoFin", SqlDbType.Time);
            sqlPar.Value = oENTInvitacion.HoraEventoFin;
            sqlCom.Parameters.Add(sqlPar);

            sqlPar = new SqlParameter("MotivoRechazo", SqlDbType.VarChar);
            sqlPar.Value = oENTInvitacion.MotivoRechazo;
            sqlCom.Parameters.Add(sqlPar);
        ...
        ///<remarks>
        ///   <name>DAInvitacion.UpdateInvitacion_Aprobar</name>
        ...
        ///<param name="iAlternateDBTimeout">Valor en milisegundos del Timeout en la consulta a la base de datos. 0 si se desea el Timeout por default</param>
        ///<returns>Una entidad de respuesta</returns>
        public ENTResponse UpdateInvitacion_Aprobar(ENTInvitacion oENTInvitacion, String sConnection, Int32 iAlternateDBTimeout){
            SqlConnection sqlCnn = new SqlConnection(sConnection);
            SqlCommand sqlCom;
            SqlParameter sqlPar;
            SqlDataAdapter sqlDA;
            ...
            // Configuración de objetos
            sqlCom = new SqlCommand("uspInvitacion_Upd_Aprobar", sqlCnn);
            sqlCom.CommandType = CommandType.StoredProcedure;
        ...
        ///<remarks>
        ///   <name>DAInvitacion.UpdateInvitacion_Declinar</name>
        ///   <create>12-Enero-2015</create>
        ///   <author>Ruben.Cobos</author>
        ///</remarks>
        ...
        ///<param name="iAlternateDBTimeout">Valor en milisegundos del Timeout en la consulta a la base de datos. 0 si se desea el Timeout por default</param>
        ///<returns>Una entidad de respuesta</returns>
        public ENTResponse UpdateInvitacion_Declinar(ENTInvitacion oENTInvitacion, String sConnection, Int32 iAlternateDBTimeout){
            SqlConnection sqlCnn = new SqlConnection(sConnection);
            SqlCommand sqlCom;
            SqlParameter sqlPar;
            SqlDataAdapter sqlDA;
            ...
            // Configuración de objetos
            sqlCom = new SqlCommand("uspInvitacion_Upd_Declinar", sqlCnn);
            sqlCom.CommandType = CommandType.StoredProcedure;
