...
{
    public class DARespuestaEvaluacion : DABase
    {

        ///<remarks>
        ///   <name>DARespuestaEvaluacion.SelectRespuestaEvaluacion</name>
        ...
        public ENTResponse SelectRespuestaEvaluacion(ENTRespuestaEvaluacion oENTRespuestaEvaluacion, String sConnection, Int32 iAlternateDBTimeout){
            ...
            sqlCom = new SqlCommand("uspRespuestaEvaluacion_Sel", sqlCnn);
            ...
            sqlPar.Value = oENTRespuestaEvaluacion.RespuestaEvaluacionId;
            sqlCom.Parameters.Add(sqlPar);

            sqlPar = new SqlParameter("Nombre", SqlDbType.VarChar);
            sqlPar.Value = oENTRespuestaEvaluacion.Nombre;
            sqlCom.Parameters.Add(sqlPar);

            sqlPar = new SqlParameter("Activo", SqlDbType.TinyInt);
            sqlPar.Value = oENTRespuestaEvaluacion.Activo;
            sqlCom.Parameters.Add(sqlPar);
