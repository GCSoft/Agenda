...
namespace Agenda.DataAccess.Object
{
    public class DAGira : DABase
    {
        ...
        public ENTResponse InsertGiraConfiguracion(ENTGira oENTGira, String sConnection, Int32 iAlternateDBTimeout){
            ...
            sqlPar = new SqlParameter("tblDespedidaHelipuerto", SqlDbType.Structured);
            sqlPar.Value = oENTGira.DataTableDespedidaHelipuerto;
            sqlCom.Parameters.Add(sqlPar);
        ...
        ///<remarks>
        ///   <name>DAGira.UpdateGiraDespedidaHelipuerto_Item</name>
        ///   <create>07-Enero-2014</create>
        ///   <author>Ruben.Cobos</author>
        ///</remarks>
        public ENTResponse UpdateGiraDespedidaHelipuerto_Item(ENTGira oENTGira, String sConnection, Int32 iAlternateDBTimeout){
            SqlConnection sqlCnn = new SqlConnection(sConnection);
            SqlCommand sqlCom;
            SqlParameter sqlPar;
            SqlDataAdapter sqlDA;
            ...
            // Configuración de objetos
            sqlCom = new SqlCommand("uspGiraDespedidaHelipuerto_Upd_Item", sqlCnn);
            sqlCom.CommandType = CommandType.StoredProcedure;
