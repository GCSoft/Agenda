...
namespace Agenda.Entity.Object
{
    public class ENTGira : ENTBase
    {
        ...
        private DataTable   _DataTableDespedidaHelipuerto;
        ...
        public ENTGira()
        {
            ...
            _DataTableDespedidaHelipuerto = null;
        ...
        ///<remarks>
        ///   <name>ENTGira.DataTableDespedidaHelipuerto</name>
        ///   <create>19-Diciembre-2014</create>
        ///   <author>Ruben.Cobos</author>
        ///</remarks>
        ///<summary>Obtiene/Asigna un DataTable el cual contiene el detalle del comité de recepción del helipuerto</summary>
        public DataTable DataTableDespedidaHelipuerto
        {
            get { return _DataTableDespedidaHelipuerto; }
            set { _DataTableDespedidaHelipuerto = value; }
        }
