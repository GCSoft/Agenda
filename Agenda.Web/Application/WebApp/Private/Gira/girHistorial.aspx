<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="girHistorial.aspx.cs" Inherits="Agenda.Web.Application.WebApp.Private.Gira.girHistorial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
    ...
    <asp:Panel ID="pnlGrid" runat="server" CssClass="GridPanel">
        <asp:GridView ID="gvGiraSeguimiento" runat="server" AllowPaging="false" AllowSorting="true"  AutoGenerateColumns="False" Width="100%"
			DataKeyNames="GiraSeguimientoId,UsuarioId,RowNumber"
			OnRowDataBound="gvGiraSeguimiento_RowDataBound" 
			OnSorting="gvGiraSeguimiento_Sorting">
			...
			<Columns>
                ...
                <asp:BoundField HeaderText="Antes"          ItemStyle-HorizontalAlign="Left"                            DataField="Antes"                   HtmlEncode="false"  SortExpression="Antes"></asp:BoundField>
                <asp:BoundField HeaderText="Después"        ItemStyle-HorizontalAlign="Left"                            DataField="Despues"                 HtmlEncode="false"  SortExpression="Despues"></asp:BoundField>
			</Columns>
		</asp:GridView>
    </asp:Panel>
