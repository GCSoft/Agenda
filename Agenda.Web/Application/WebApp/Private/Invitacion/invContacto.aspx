...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
    ...
    <asp:Panel ID="pnlPageName" runat="server" CssClass="MasterPageName">
        <asp:Label ID="lblPageName" runat="server" CssClass="PageNameText" Text="Contactos asociados a la invitación"></asp:Label>
    </asp:Panel>

    <asp:Panel ID="pnlTitulo" runat="server" CssClass="TitlePanel">
        <table class="HeaderTable">
            <tr>
                <td class="Titulo"><asp:Label ID="lblSubTitulo" runat="server" Text="Edite la información de los contactos asociados a la invitación o bien, agregue uno nuevo."></asp:Label></td>
            </tr>
        </table>
    </asp:Panel>
        ...
        <asp:Panel ID="pnlPopUpContent" runat="server" CssClass="PopUpContent" style="margin-top:-265px; margin-left:-310px;" Height="510px" Width="620px">
            ...
            <asp:Panel ID="pnlPopUpBody" runat="server" CssClass="PopUpBody">
                <table class="PopUpBodyTable">
                    ...
                    <tr>
				        <td colspan="3">
                            <CKEditor:CKEditorControl ID="ckePopUpComentarios" BasePath="~/Include/Components/CKEditor/Core" runat="server" Height="130px" ContentsCss="~/Include/Components/CKEditor/Core/contents.css" TemplatesFiles="~/Include/Components/CKEditor/Core/plugins/templates/templates/default.js" Width=""></CKEditor:CKEditorControl>
				        </td>
			        </tr>
                    <tr>
