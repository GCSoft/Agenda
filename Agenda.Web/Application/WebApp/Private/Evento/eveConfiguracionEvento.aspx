        ...
        <table border="0" style="width:100%">
			...
			<tr>
				<td colspan="4" style="text-align:left; vertical-align:bottom;">
					<CKEditor:CKEditorControl ID="ckeMenu" BasePath="~/Include/Components/CKEditor/Core" runat="server" Height="96px" ContentsCss="~/Include/Components/CKEditor/Core/contents.css" TemplatesFiles="~/Include/Components/CKEditor/Core/plugins/templates/templates/default.js" Width=""></CKEditor:CKEditorControl>
				</td>
			</tr>
		</table>
    </asp:Panel>
