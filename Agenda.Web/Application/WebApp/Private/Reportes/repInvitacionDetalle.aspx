<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="repInvitacionDetalle.aspx.cs" Inherits="Agenda.Web.Application.WebApp.Private.Reportes.repInvitacionDetalle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
    ...
    <asp:Panel ID="pnlTitulo" runat="server" CssClass="TitlePanel">
        <table class="HeaderTable">
            <tr>
                <td class="Titulo"><asp:Label ID="lblSubTitulo" runat="server" Text="Ajuste los filtros para poder visualizar el reporte de detalle de invitaciones."></asp:Label></td>
            </tr>
        </table>
    </asp:Panel>
    ...
    <asp:Panel ID="pnlReporte" runat="server" CssClass="ReportePanel">
        <asp:Panel ID="pnlReporteCanvas" runat="server" CssClass="ReportePanelCanvas">
            <rsweb:ReportViewer ID="rptInvitacionDetalle" runat="server" SizeToReportContent="True"></rsweb:ReportViewer>
        </asp:Panel>
